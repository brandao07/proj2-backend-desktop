...
public class ConsultarEditarDadosTipoRecintoController implements Initializable {
    @FXML
    ...
    @FXML
    private TableView tableTipoRecintos;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        itemPesquisar.setValue("Tipos de Recintos");
