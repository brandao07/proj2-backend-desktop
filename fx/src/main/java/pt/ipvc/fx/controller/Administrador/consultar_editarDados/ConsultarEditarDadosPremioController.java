...
public class ConsultarEditarDadosPremioController implements Initializable {
    @FXML
    ...
    @FXML
    private TableView tablePremios;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        itemPesquisar.getItems().addAll("Árbitros", "Atletas", "Equipas", "Modalidade", "Prémios", "Recintos", "Tipos de Recintos", "Tipos de Prêmios");
        itemPesquisar.setValue("Prémios");
