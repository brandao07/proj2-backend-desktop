...
public class ConsultarEditarDadosRecintoController implements Initializable {
    @FXML
    ...
    @FXML
    private TableView tableRecintos;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        itemPesquisar.getItems().addAll("Árbitros", "Atletas", "Equipas", "Modalidade", "Prêmios", "Recintos", "Tipos de Recintos", "Tipos de Prêmios");
        itemPesquisar.setValue("Recintos");
...
//  RecintoBLL.getRecintos();
    //TUDO: HUGO OBTER
// Recinto recinto = RecintoBLL.getRecinto(nome);
    //TUDO: HUGO UPDATE
